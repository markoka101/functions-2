...
const uniq = (arr, cb) => {
  ...
  cb(arr); //Since arrow has implicit return I am pretty sure this correct?
}
...
// CODE HERE
const modArr = uniqArr =>console.log('The new names array with all the duplicate items removed is ' + uniqArr);
...
// CODE HERE
const cbEach = (item, index) => console.log(`The item at index ${index} is ${item}`);
each(names, cbEach);
...
// CODE HERE
const addingFactory = num => (fnum) => num + fnum;
...
console.log(addNumber(14563135));